...
def getWarpedImage(img):
    ...
    # grad_binary = np.dstack((grad_binary, grad_binary, grad_binary))
    warped = cv2.warpPerspective(grad_binary, M, img.shape[:2][::-1], flags=cv2.INTER_LINEAR)
    return warped[-280:,575:725]
    #return warped[-280:,600:690]
    return warped
